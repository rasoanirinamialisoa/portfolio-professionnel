      ...
      <div className="section-container px-4 sm:px-6 relative z-20">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-6 md:space-y-8 text-center lg:text-left lg:col-start-2">
            {/* Badge disponible */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-white to-blue-50 backdrop-blur-sm px-5 py-2.5 rounded-full border border-neon-purple/20 shadow-sm">
            ...
            <div className="space-y-3 md:space-y-4">
              <h2 className="text-lg md:text-2xl font-medium text-gray-600 tracking-wider uppercase">
                Bonjour, je suis
              </h2>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2">
                ...
                <div className="relative">
                  <span className="font-bold bg-gradient-to-r from-neon-purple to-neon-blue bg-clip-text text-transparent text-2xl md:text-3xl lg:text-4xl">
                    INFORMATIQUE
                  </span>
                  <div className="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-neon-purple to-neon-blue rounded-full"></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-6 shadow-lg max-w-lg mx-auto lg:mx-0 group hover:shadow-xl hover:border-neon-purple/30 transition-all duration-300">
              ...
              <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                ...
                performantes. Spécialisé en{" "}
                <span className="text-neon-blue font-medium">front-end</span>,{" "}
                <span className="text-neon-purple font-medium">back-end</span>{" "}
                et en solutions{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button className="group relative overflow-hidden bg-gradient-to-r from-neon-blue to-neon-purple text-white w-full sm:w-auto px-8 py-6 rounded-xl border-0 shadow-lg hover:shadow-2xl hover:shadow-neon-blue/40 transition-all duration-300 transform hover:-translate-y-1">
              ...
              <Button
                variant="outline"
                className="group relative w-full sm:w-auto px-8 py-6 rounded-xl border-2 border-neon-purple/30 bg-white text-gray-800 hover:bg-gradient-to-r hover:from-white hover:to-purple-50 hover:border-neon-purple hover:text-neon-purple transition-all duration-300 transform hover:-translate-y-1 shadow-md hover:shadow-xl"
              >
                <span className="relative z-10 flex items-center gap-3 font-semibold">
                  Voir mes projets
            ...
            <div className="pt-6">
              <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="absolute bottom-8 right-8 hidden lg:block">
              <div className="flex flex-col items-center gap-3 text-gray-500">
                ...
                <div className="relative w-6 h-10 rounded-full border-2 border-gray-300">
                  <div className="absolute top-1 left-1/2 -translate-x-1/2 w-1.5 h-3 bg-gradient-to-b from-neon-purple to-neon-blue rounded-full animate-scroll"></div>
                </div>
              </div>
            </div>
          </div>
