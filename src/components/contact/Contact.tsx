      ...
      <div className="section-container max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-5 md:gap-7 lg:gap-10 mt-4 md:mt-6">
            {/* Carte des contacts */}
            <div
              className={`rounded-2xl shadow-lg p-5 md:p-7 transition-colors duration-300 ${
                isDark
            ...
            >
              <h3
                className={`text-xl md:text-2xl font-bold mb-4 md:mb-5 transition-colors duration-300 ${
