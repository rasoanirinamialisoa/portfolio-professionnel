// features/projects/components/Projects.tsx
...
const Projects = () => {
  ...
  const { activeTab, setActiveTab, filteredProjects } = useProjectFilters(projectsData);
  ...
  return (
    <section id="projects" className={`py-24 ${bgClasses} transition-colors duration-300`}>
