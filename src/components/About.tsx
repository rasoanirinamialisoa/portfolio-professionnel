    ...
    <section id="about" className="relative min-h-screen pt-16 md:pt-20 py-20 md:py-28 bg-gradient-to-b from-white to-purple-50/30">
      <div className="section-container max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          <span className="inline-block text-sm font-medium text-neon-purple tracking-widest uppercase mb-3">
            A propos de moi
          </span>
          <h2 className="text-2xl md:text-5xl font-light text-gray-900">
            Qui suis-je <span className="text-neon-blue font-medium">?</span>
          </h2>
          <div className="w-16 h-0.5 bg-neon-purple mx-auto mt-4 rounded-full" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col items-center">
            ...
            <div className="relative">
              ...
              {/* Badge discret */}
              <div className="absolute -bottom-3 -right-3 bg-neon-purple text-white text-xs font-medium px-4 py-1.5 rounded-full shadow-lg">
                Fullstack
              </div>
            </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="flex items-start space-x-3 p-3 bg-white/60 rounded-xl hover:bg-white transition-colors duration-200">
                <User className="text-neon-purple w-4 h-4 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-white/60 rounded-xl hover:bg-white transition-colors duration-200">
                <Calendar className="text-neon-purple w-4 h-4 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-white/60 rounded-xl hover:bg-white transition-colors duration-200">
                <MapPin className="text-neon-purple w-4 h-4 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-white/60 rounded-xl hover:bg-white transition-colors duration-200">
                <Mail className="text-neon-purple w-4 h-4 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-white/60 rounded-xl hover:bg-white transition-colors duration-200">
                <Phone className="text-neon-purple w-4 h-4 mt-0.5 flex-shrink-0" />
                <div>
            ...
            <div className="bg-white/60 rounded-xl p-5 border border-purple-100/50">
              <div className="flex items-center space-x-2 mb-3">
                <Briefcase className="text-neon-purple w-4 h-4" />
              ...
              <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                ...
                <span className="text-neon-purple font-medium"> Master 2 en Pharmacologie</span>. 
                ...
                <span className="text-neon-purple font-semibold"> PHP</span> et 
                <span className="text-neon-purple font-semibold"> React</span> au service des entreprises, 
